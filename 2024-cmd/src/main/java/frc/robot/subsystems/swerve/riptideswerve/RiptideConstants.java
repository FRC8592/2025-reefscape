...
public class RiptideConstants {
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.498); //correct
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.25); //mostly correct
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.043); //misbehaving 
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.368896484375); //correct
