...
public final class Constants {
    ...
    public final class SWERVE {
        ...
        public static final double TRANSLATE_POWER_FAST = 0.075; 
        public static final double ROTATE_POWER_FAST = 0.075; 
        public static final double TRANSLATE_POWER_SLOW = 0.075;
        public static final double ROTATE_POWER_SLOW = 0.075;
