...
public final class Constants {
    ...
    public final class CORAL_ALIGN {
        ...
        public static final double OFFSET_DEPTH = 0.7; // Drivers requested for the robot to be as close to the april tag as possible
    ...
    public class ELEVATOR{
        ...
        public static final double ELEVATOR_MAX_VELOCITY = 25; //formerly 75
    ...
    public class ARM{
        ...
        public static final double ARM_MAX_VELOCITY = 25; //previously 100
    ...
    public class WRIST{
        ...
        public static final double WRIST_MAX_VELOCITY = 25; //used to be 100
