...
public class Ports {
    ...
    public static final int LEFT_ELEVATOR_MOTOR_CAN_ID = 20;
    public static final int RIGHT_ELEVATOR_MOTOR_CAN_ID = 21;
    public static final int CLOCK_MOTOR_CAN_ID = 22;
    public static final int WRIST_MOTOR_CAN_ID = 23;
    public static final int CLIMBER_MOTOR_CAN_ID = 24;
    public static final int ROLLER_TOP_MOTOR_CAN_ID = 25;
    public static final int ROLLER_BOTTOM_MOTOR_CAN_ID = 26;
}